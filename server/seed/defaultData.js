export const defaultSlots = [
  { time: '09:00', label: '9:00 AM', isActive: true },
  { time: '09:30', label: '9:30 AM', isActive: true },
  { time: '10:00', label: '10:00 AM', isActive: true },
  { time: '10:30', label: '10:30 AM', isActive: true },
  { time: '11:00', label: '11:00 AM', isActive: true },
  { time: '11:30', label: '11:30 AM', isActive: true },
  { time: '12:00', label: '12:00 PM', isActive: true },
  { time: '12:30', label: '12:30 PM', isActive: true },
  { time: '14:00', label: '2:00 PM', isActive: true },
  { time: '14:30', label: '2:30 PM', isActive: true },
  { time: '15:00', label: '3:00 PM', isActive: true },
  { time: '15:30', label: '3:30 PM', isActive: true },
  { time: '16:00', label: '4:00 PM', isActive: true },
  { time: '16:30', label: '4:30 PM', isActive: true },
  { time: '17:00', label: '5:00 PM', isActive: true },
  { time: '17:30', label: '5:30 PM', isActive: true },
  { time: '18:00', label: '6:00 PM', isActive: true },
  { time: '18:30', label: '6:30 PM', isActive: true },
];

export const defaultContent = {
  heroTitle: 'Classical Homeopathy for Mind & Body',
  heroSubtitle:
    "One of Karnataka's premier homeopathic clinics practicing classical homeopathy influenced by the teachings of Dr. Prafful Vijaykar. We treat the whole person — boosting immunity and inner strength while addressing both mental and physical aspects.",
  heroBadgeText: 'Established 1998 • 28 Years of Healing',
  heroImage: '',
  aboutTitle: 'Healing Through Classical Homeopathy',
  aboutDescription:
    'Established in 1998, Manu Homeopathy Clinic & Research Center is one of the few homeopathic clinics in Karnataka where classical homeopathy is practiced. Influenced by the profound teachings of Dr. Prafful Vijaykar, we have been successfully treating patients with ailments ranging from common colds to complex diseases for over 28 years.',
  aboutImage: '',
  stats: [
...
export const defaultBlogs = [
  {
    ...
    excerpt:
      'Learn how constitutional treatment addresses your unique physical and mental characteristics for lasting wellness.',
...
<li>Enhanced immunity</li>
  ...
  },
  {
    ...
    excerpt:
      'Discover natural remedies for managing seasonal allergies without the drowsiness of conventional antihistamines.',
