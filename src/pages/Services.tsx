          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                treatment that addresses the root cause, not just symptoms. Our treatments are 
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                { step: "02", title: "Analysis", desc: "Thorough analysis of your case to find the remedy that matches your unique constitution" },
                { step: "03", title: "Treatment", desc: "Prescription of the appropriate remedy with clear dosing instructions" },
                ...
                <div key={index} className="text-center">
                  <div className="w-16 h-16 rounded-full bg-primary text-primary-foreground flex items-center justify-center mx-auto mb-4">
                    <span className="font-heading text-xl font-bold">{item.step}</span>
                  </div>
